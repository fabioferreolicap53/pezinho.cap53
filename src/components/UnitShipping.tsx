...
export function UnitShipping() {
  ...
  const filteredHistory = useMemo(() => {
    ...
    return filtered.filter(item => 
      ...
      item.shippings.some(s => s.unit.toLowerCase().includes(lowerTerm))
    );
      ...
      <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-6 mb-8">
        <div className="flex items-start gap-4">
          ...
          <div className="flex-1">
            <h1 className="text-2xl md:text-3xl lg:text-h1 font-black text-on-surface">Envio de Insumos</h1>
            <p className="text-sm md:text-body-md text-on-surface-variant mt-1 w-full">
              Controle de saída de insumos (Filtros, Lancetas e Envelopes).
            </p>
          </div>
        </div>
        <button
          ...
          <table className="w-full text-left border-collapse">
            <thead>
              <tr className="bg-surface-container-high border-b border-outline-variant">
                <th className="px-xl py-lg font-label-caps text-[11px] text-on-surface-variant uppercase tracking-wider text-center">Data do Envio</th>
                <th className="px-xl py-lg font-label-caps text-[11px] text-on-surface-variant uppercase tracking-wider text-center">Unidades</th>
                <th className="px-xl py-lg font-label-caps text-[11px] text-on-surface-variant uppercase tracking-wider text-center">Filtro Verm.</th>
                <th className="px-xl py-lg font-label-caps text-[11px] text-on-surface-variant uppercase tracking-wider text-center">Filtro Azul</th>
                <th className="px-xl py-lg font-label-caps text-[11px] text-on-surface-variant uppercase tracking-wider text-center">Lanceta</th>
                <th className="px-xl py-lg font-label-caps text-[11px] text-on-surface-variant uppercase tracking-wider text-center">Envelope</th>
                <th className="px-xl py-lg font-label-caps text-[11px] text-on-surface-variant uppercase tracking-wider text-center">Total Geral</th>
                <th className="px-xl py-lg font-label-caps text-[11px] text-on-surface-variant uppercase tracking-wider text-center">Registro</th>
